...
const Modal: React.FC<ModalProps> = ({
    ...
    return ( 
        <>
        <div className="justify-content items-center flex overflow-x-hidden
        overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
            ...
            mx-auto h-full lg:h-auto md:h-auto">
                ...
                ${showModal ? 'opacity-100': 'opacity-0'}`}>
                    <div className="transition h-full lg:h-auto md:h-auto border-0
                    rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        {/* header */}
